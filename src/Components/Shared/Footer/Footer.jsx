...
const Footer = () => {
    return (
        <div>
            <div className="md:h-[25rem] bg-[#F3F3FA] p-5 md:p-0 w-full flex justify-center md:justify-evenly items-center flex-col md:flex-row">
                <div className="opacity-50 ">
                    <svg className="w-[7rem] md:w-auto" xmlns="http://www.w3.org/2000/svg" width="217" height="217" viewBox="0 0 217 217" fill="none">
