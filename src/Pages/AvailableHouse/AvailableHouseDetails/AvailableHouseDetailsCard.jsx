...
const AvailableHouseDetailsCard = ({data}) => {
    return (
        <div className="w-[60vw]">
                ...
                <img className="mt-10 w-full h-[33rem] rounded-t-2xl shadow-md" src={data?.image} alt="" />

                <div className="mt-12 flex justify-evenly items-center">
                    <div className="flex gap-6 items-center">
                        <img src={house} alt="" />
                        <h1 className="text-[#141B2D] merrin font-semibold text-[1.4rem]">{data?.roomsno} Room</h1>
                    </div>
                    <div className="flex gap-6 items-center">

                        <h1 className="text-[#141B2D] merrin font-semibold text-[1.4rem]">${data?.price}</h1>
                    </div>
                    <div className="flex gap-6 items-center">
                        <img src={location} alt="" />
                        <h1 className="text-[#141B2D] merrin font-semibold text-[1.4rem]">{data?.location}</h1>
                    </div>
                </div>
